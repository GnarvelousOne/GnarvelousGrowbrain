...
lights_on_hour.grid(row = 1, column = 0, sticky = entry_sticky, padx = label_entry_padx)
lights_on_minute.grid(row = 1, column = 1, sticky = entry_sticky, padx = label_entry_padx)
lights_off_hour.grid(row = 3, column = 0, sticky = entry_sticky, padx = label_entry_padx)
lights_off_minute.grid(row = 3, column = 1, sticky = entry_sticky, padx = label_entry_padx)
