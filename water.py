...
label1 = ttk.Label(window, text = 'Water ON\nHour:', bootstyle = 'info')
label2 = ttk.Label(window, text = 'Water ON\nMinute:', bootstyle = 'info')
label3 = ttk.Label(window, text = 'Water OFF\nHour:', bootstyle = 'info')
label4 = ttk.Label(window, text = 'Water OFF\nMinute:', bootstyle = 'info')


water_on_hour_var = tk.StringVar()
water_on_minute_var = tk.StringVar()
water_off_hour_var = tk.StringVar()
water_off_minute_var = tk.StringVar()
...
save.grid(row = 4, column = 0, columnspan = 2, sticky = 'nsew', padx = label_entry_padx, pady = label_entry_padx)
resetb.grid(row = 4, column = 2, columnspan = 2, sticky = 'nsew', padx = label_entry_padx, pady = label_entry_padx)
adios.grid(row = 4, column = 4, columnspan = 2, sticky = 'nsew', padx = label_entry_padx, pady = label_entry_padx)

label1.grid(row = 0, column = 0, sticky = label_sticky, padx = label_entry_padx)
label2.grid(row = 0, column = 1, sticky = label_sticky, padx = label_entry_padx)
label3.grid(row = 2, column = 0, sticky = label_sticky, padx = label_entry_padx)
label4.grid(row = 2, column = 1, sticky = label_sticky, padx = label_entry_padx)

water_on_hour.grid(row = 1, column = 0, sticky = entry_sticky, padx = label_entry_padx)
water_on_minute.grid(row = 1, column = 1, sticky = entry_sticky, padx = label_entry_padx)
water_off_hour.grid(row = 3, column = 0, sticky = entry_sticky, padx = label_entry_padx)
water_off_minute.grid(row = 3, column = 1, sticky = entry_sticky, padx = label_entry_padx)

keypad9.grid(row = 0, column = 5, sticky = keypad_sticky, padx = keypad_padding, pady = keypad_padding)
keypad8.grid(row = 0, column = 4, sticky = keypad_sticky, padx = keypad_padding, pady = keypad_padding)
keypad7.grid(row = 0, column = 3, sticky = keypad_sticky, padx = keypad_padding, pady = keypad_padding)
keypad6.grid(row = 1, column = 5, sticky = keypad_sticky, padx = keypad_padding, pady = keypad_padding)
keypad5.grid(row = 1, column = 4, sticky = keypad_sticky, padx = keypad_padding, pady = keypad_padding)
keypad4.grid(row = 1, column = 3, sticky = keypad_sticky, padx = keypad_padding, pady = keypad_padding)
keypad3.grid(row = 2, column = 5, sticky = keypad_sticky, padx = keypad_padding, pady = keypad_padding)
keypad2.grid(row = 2, column = 4, sticky = keypad_sticky, padx = keypad_padding, pady = keypad_padding)
keypad1.grid(row = 2, column = 3, sticky = keypad_sticky, padx = keypad_padding, pady = keypad_padding)
keypad0.grid(row = 3, column = 4, columnspan = 2, sticky = keypad_sticky, padx = keypad_padding, pady = keypad_padding)
keypad_clear.grid(row = 3, column = 3, sticky = keypad_sticky, padx = keypad_padding, pady = keypad_padding)
