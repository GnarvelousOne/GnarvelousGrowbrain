...
water_on_hour.grid(row = 1, column = 0, columnspan = 2, sticky = entry_sticky, padx = label_entry_padx)
water_on_minute.grid(row = 1, column = 2, columnspan = 2, sticky = entry_sticky, padx = label_entry_padx)
water_off_hour.grid(row = 3, column = 0, columnspan = 2, sticky = entry_sticky, padx = label_entry_padx)
water_off_minute.grid(row = 3, column = 2, columnspan = 2, sticky = entry_sticky, padx = label_entry_padx)
