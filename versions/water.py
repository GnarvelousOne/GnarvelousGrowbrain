...
def man_on():
	...
	c.execute("UPDATE gb SET water_manual = ?", (True,))
...
def man_off():
	...
	c.execute("UPDATE gb SET water_manual = ?", (False,))
...
manual_on = ttk.Button(window, text='ON', command=man_on, bootstyle = 'secondary', style = 'secondary.TButton')
manual_off = ttk.Button(window, text='OFF', command=man_off, bootstyle = 'secondary', style = 'secondary.TButton')
...
label1 = ttk.Label(window, text = 'ON\nHour:', font = label_font, bootstyle = 'info')
label2 = ttk.Label(window, text = 'ON\nMinute:', font = label_font, bootstyle = 'info')
...
water_off_hour.grid(row = 3, column = 3, sticky = entry_sticky, padx = label_entry_padx)
water_off_minute.grid(row = 3, column = 4, sticky = entry_sticky, padx = label_entry_padx)
